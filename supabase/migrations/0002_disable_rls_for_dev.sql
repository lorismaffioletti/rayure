-- Migration temporaire : Désactiver RLS pour le développement
-- ⚠️ À NE PAS UTILISER EN PRODUCTION
-- Cette migration permet l'accès sans authentification pour le développement
...
-- Permet l'accès à tous (authentifiés ou non)
do $$
declare
  t record;
begin
